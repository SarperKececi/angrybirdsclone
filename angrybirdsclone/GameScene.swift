...
//  angrybirdsclone
//
//  Created by Sarper Kececi on 5.10.2023.
//
   ...
   var score = 0
    ...
    override func didMove(to view: SKView) {
        /*
         ...
         bird2.size = CGSize(width: 70, height: 70)
         bird2.zPosition = 1
         self.addChild(bird2)
    ...
    override func update(_ currentTime: TimeInterval) {
        if let birdPhysicsBody = bird.physicsBody {
            // Kuşun hızını kontrol edin (kuşun hızı sıfıra yakınsa).
